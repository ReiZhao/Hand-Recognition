...
if __name__ == "__main__":
    ...
    while camera.isOpened():
        ...
        if isBgCaptured == 1:
            ...
            if triggerSwitch:
                ...
                if length > 0:
                    ...
                    write_file("hand_feature_full.txt", humoments)
            ...
            if matchingSwitch:
                ...
                if match_result <= 0.15:
                    drawing = cv2.putText(thresh, "matching!", (0, 40), font, 1.2, (255, 255, 255), 2)
                if match_result > 0.15:
                    drawing = cv2.putText(thresh, "no_matching!", (0, 40), font, 1.2, (255, 255, 255), 2)
        ...
        if k == 27:  # 按下ESC退出，并为文件更新一行
            f = open("hand_feature_full.txt", "a")
            f.write("\n")
            f.close()
            break
